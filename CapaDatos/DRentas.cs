...
namespace CapaDatos
{
    public class DRentas
    {
        ...
        public int Guardar(MRentas Rentas)
        {
            ...
            else
            {
                ...
                if (RentasInDb != null)
                {
                    ...
                    RentasInDb.FechaRenta = Rentas.FechaRenta;
        ...
        {
            var RentasInDb = _unitOfWork.Repository<MClientes>().Consulta().FirstOrDefault(c => c.RentaId == clienteId);
            if (RentasInDb != null)
            {
                _unitOfWork.Repository<MClientes>().Eliminar(RentasInDb);
                return _unitOfWork.Guardar();
            }
            return 0;
        }
